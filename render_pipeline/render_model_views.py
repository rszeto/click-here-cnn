...
# Based on http://blender.stackexchange.com/a/1008
def camToPixelCoords(scene, camObj, pt):
    pt2d = bpy_extras.object_utils.world_to_camera_view(scene, camObj, pt)
    # Change coordinate system to be consistent with pixel coordinates
    pt2d.y = 1 - pt2d.y
