...
if __name__ == '__main__':
    ...
    #     trainPath = os.path.join(g_syn_images_lmdb_folder, name+'_train.txt')
    #     testPath = os.path.join(g_syn_images_lmdb_folder, name+'_test.txt')
    #     if (not os.path.exists(trainPath)) and (not os.path.exists(testPath)):
    #         get_one_category_image_label_file(synset, trainPath, testPath)
    ...
    #     combine_files(input_file_list, output_file, maxNum=1)
